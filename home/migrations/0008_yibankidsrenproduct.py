# -*- coding: utf-8 -*-
# Generated by Django 1.11.11 on 2019-12-25 16:33
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('home', '0007_auto_20191225_2344'),
    ]

    operations = [
        migrations.CreateModel(
            name='YibanKidsrenProduct',
            fields=[
                ...
                ('shopid', models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='kidsproducts', to='home.YibanShop')),
            ],
            options={
